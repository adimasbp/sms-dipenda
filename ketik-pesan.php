            ...
            <div class="tab-pane active" id="PS">
                <form class="form-horizontal "action="#">
                    <fieldset>
                          ...
                          <div class="control-group">
                            <label class="control-label">Masukan Nomor</label>
                              <div class="controls">
                                ...
                                <button type="submit" class="btn btn-default"><i class="fa fa-search fa-fw"></i>Cari</button>
                        ...
                        <div class="controls">
                        <br>
                                <button type="submit" class="btn btn-primary"><i class="fa fa-paper-plane-o fa-fw"></i>Kirim</button>
                                <button type="submit" class="btn btn-danger"><i class="fa fa-times"></i>Batal</button>
                          </div>
                        </div>
                    </fieldset>           
            </form>
